...
const req = https.request({
	...
	key: fs.readFileSync(`${__dirname}/ssl-client/ph-key.txt`),
	passphrase: "client", // ----> optional
	cert: fs.readFileSync(`${__dirname}/ssl-client/ph-cert.txt`),
	ca: [
		fs.readFileSync(`${__dirname}/ssl-server/ph-cert.txt`)
	],
	path: "/",
	method: "GET",
	headers: {
